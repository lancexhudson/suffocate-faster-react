  ...
  return (
    <div className="hero-bio-container">
      ...
      <p id="about">
        ...
        REMAINED ACTIVE, PLAYING FESTIVALS AND TOURING THE UNITED STATES. IN
        APRIL 2023, SUFFOCATE FASTER SIGNED WITH SMARTPUNK RECORDS AND RELEASED
        THEIR FIRST SINGLE IN OVER A DECADE, "LOST ONES" OFF THE EP "THIS IS THE
        WAY VOL. 1" SET TO BE RELEASED IN JUNE 2023.
      </p>
      <div>
        <img
